// say-about-me/testimonials.de.ts
export const TESTIMONIALS = [
  {
    quote: '„Marc hat durch seine zuverlässige und qualitativ hochwertige Arbeit einen wesentlichen Beitrag zum Erfolg des Projekts geleistet. Seine Fähigkeit, sich auch bei komplexeren Problemen nicht entmutigen zu lassen, sorgte dafür, dass er auftretende Herausforderungen stets effizient lösen konnte. Er bewies dabei nicht nur fachliche Kompetenz, sondern auch eine bemerkenswerte Ausdauer und Lösungsorientierung.“',
    author: '– Miles Pickull, Teamkollege'
  },
  {
